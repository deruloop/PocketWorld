...
public final class CountriesQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(name: String, native: String, capital: String? = nil, currency: String? = nil, continent: Continent, languages: [Language], emoji: String) {
        self.init(unsafeResultMap: ["__typename": "Country", "name": name, "native": native, "capital": capital, "currency": currency, "continent": continent.resultMap, "languages": languages.map { (value: Language) -> ResultMap in value.resultMap }, "emoji": emoji])
      }
